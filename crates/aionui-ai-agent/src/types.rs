...
pub const AIONUI_USER_ID_ENV: &str = "CARBONFUSION_USER_ID";
pub const AIONUI_CONVERSATION_ID_ENV: &str = "CARBONFUSION_CONVERSATION_ID";
pub const AIONUI_HELPER_BIN_ENV: &str = "CARBONFUSION_HELPER_BIN";
pub const AIONUI_BASE_URL_ENV: &str = "CARBONFUSION_BASE_URL";
pub const AIONUI_RUNTIME_TOKEN_ENV: &str = "CARBONFUSION_RUNTIME_TOKEN";
